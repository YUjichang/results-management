...
import { importClasses } from '@/api/classes/table'
...
export default {
  ...
  methods: {
    ...
    importData(file) {
      ...
      importClasses(formdata, config).then(() => {
        this.$notify({
          title: '成功',
          message: '批量导入成功',
          type: 'success',
    ...
    handleExport() {
      ...
      elemIF.src = 'http://47.106.206.157/resource/templates/class_import_template.xlsx'
