...
import { importResults } from '@/api/results/table'
...
export default {
  ...
  methods: {
    ...
    importData(file) {
      ...
      importResults(formdata, config).then(() => {
        this.$notify({
          title: '成功',
          message: '批量导入成功',
          type: 'success',
    ...
    handleExport() {
      ...
      elemIF.src = 'http://47.106.206.157/resource/templates/result_import_template.xlsx'
